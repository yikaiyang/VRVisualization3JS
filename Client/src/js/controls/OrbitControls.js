...
THREE.OrbitControls = function ( object, domElement, renderCallback, coord) {

    this.object = object;
    
    this.renderCallback = renderCallback; //If a rerender is needed this method is called.
    this.coord = coord;
	...
	this.maxDistance = 20000000; // Default: Infinity
	...
	this.minAzimuthAngle = -Math.PI/2; // radians   Default:  -Infinity
	this.maxAzimuthAngle = Math.PI/2; // radians        Default:   Infinity
