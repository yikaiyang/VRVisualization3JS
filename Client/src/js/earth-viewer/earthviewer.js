...
import CallbackHelper from '../core/callbackHelper.js';

let threeGlobals = Globals.getInstance();
let callbackHelper = new CallbackHelper();

let scene = threeGlobals.scene;

let earth = new THREE.Object3D();
const defaultLatitude = 48.210033;
const defaultLongitude = 16.363449;
