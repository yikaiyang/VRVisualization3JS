...
EarthProperties.ZOOM_LEVEL_MIN = 4;
...
class EarthViewer{
    ...
    rerenderEarth(
        ...
        if (lonStamp != longitude || latStamp != longitude) {
            ...
            var oldXtile = xtile;
            var oldYtile = ytile;
            xtile = GeoConversion.long2tile(lonStamp, this.zoom);
            ytile = GeoConversion.lat2tile(latStamp, this.zoom);
...
let viewer = new EarthViewer(scene);
